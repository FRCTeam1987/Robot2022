...
/**
 * =====
 * This is copy pasta of the SwerveControllerCommand, except that it uses PathPlaner's holonomic angle.
 * This is hacky and can be done with overloading or using the built-in `desiredRotation` supplier.
...
public class PathPlannerSwerveControllerCommand extends CommandBase {
  ...
  public PathPlannerSwerveControllerCommand(
