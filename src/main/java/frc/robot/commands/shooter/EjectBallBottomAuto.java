...
public class EjectBallBottomAuto extends SequentialCommandGroup {
  private final CollectorSubsystem m_collector;
  private final StorageSubsystem m_storage;
  /** Creates a new EjectOneBallTop. */
  public EjectBallBottomAuto(final StorageSubsystem storage, final CollectorSubsystem collector) {
