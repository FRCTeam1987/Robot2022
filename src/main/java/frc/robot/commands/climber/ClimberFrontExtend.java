...
public class ClimberFrontExtend extends SequentialCommandGroup {
  ...
  public ClimberFrontExtend(ClimberSubsystem climberSubsystem) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new SequentialCommandGroup(
          new InstantCommand(() -> climberSubsystem.climberFrontExtend(0.75)),
          new WaitUntilCommand(() -> Math.abs(climberSubsystem.getFrontPosition()) > Constants.Climber.initialExtendPosition), //20
