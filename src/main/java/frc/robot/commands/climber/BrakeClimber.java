...
public class BrakeClimber extends InstantCommand {
  ...
  public BrakeClimber(ClimberFrontSubsystem climberFrontSubsystem, ClimberBackSubsystem climberBackSubsystem) {
  ...
  public void initialize() {
    m_climberFrontSubsystem.brakeMotor();
    m_climberBackSubsystem.brakeMotor();
  }
