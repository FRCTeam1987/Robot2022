...
public final class Limelight {
  ...
  /**
   * Creates an instance of the Limelight class given the name of the Limelight.
   * For example,
  ...
  public Vector2d getTargetPosition() {
    return new Vector2d(Math.toRadians(tx.getDouble(0)), Math.toRadians(ty.getDouble(0)));
  }
  ...
  /**
   * Sets whether you want the Limelight to take snapshots or not. When it's
   * taking snapshots, it will do it
   * twice every second.
   * 
